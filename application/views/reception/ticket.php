    ...
    <div class="modal-dialog">
        <div class="modal-content" >
            ...
            <center>
                ...
                <h5 class="addrss">Mobile: <?php echo $this->db->get('settings')->row()->phone; ?></h5>
                <h4 class="addrss"><?php echo lang('indoor').' / '.lang('outdoor').' '.lang('ticket'); ?></h4>
                ...
                <table border="3px">
                    <tr>
                        <td class="tctbl"><?php  echo lang('date'); ?></td>
                    ...
                    <tr style="height: 20px" >
                        <td class="tctbl">Age:</td>
                        <td class="tctbl">Weight:</td>
                    </tr>
                    <tr>
...
$(document).ready(function () {
    $(".printbnt").click(function (e) {
        ...
        $.ajax({
            ...
            $('.age').append(ticketprint.ticketss.age).end()
